...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $mail->addAddress($drawerDetails['recipient_email'], $drawerDetails['recipient_name']);
    $mail->AddEmbeddedImage(__DIR__ . "/../temp/bar_{$uniqueImgId}.png", 'barcode');
    
    $mail->Subject = "EasyLocker Drawer Reservation For You";
    $mail->Body = "Hello {$drawerDetails['recipient_name']}!<br>
    A drawer for you has been reserved from EasyLocker. These are the details of the reservation. If you can't see the barcode image, there may be a problem with your email client.<br><br>
